...
# افعال و کلیدواژه‌ها
ATTACK_WORDS = ["حمله", "بزن", "بکوب", "ضربت", "شمشیر", "تبر", "کمان", "تیر", "خنجر",
               "حمله‌ور", "هجوم", "شلیک", "بنداز", "درگیری", "بجنگ", "جنگ", "غافلگیر",
               "می‌زنم", "میزنم", "حمله‌کن", "حمله می‌کنم", "بزنمش", "بزنش"]
DODGE_WORDS = ["دفاع", "محافظت", "سنگر", "جاخالی", "جا خالی", "سپر", "بلاک", "دفاع‌کن"]
CAST_WORDS = ["طلسم", "جادو", "شعله", "آتیش", "آتش", "آذرخش", "شفا", "مداوا", "درمان",
              "موشک", "انفجار", "یخ", "نور", "جادوگری"]
SKIP_WORDS = ["رد", "عبور", "نوبت", "ردشو", "رد می‌شم", "صرف‌نظر", "بگذر"]
DEATH_WORDS = ["مرگ‌سیو", "مرگ سیو", "مرگ‌سیو", "نجات", "پایدار", "deathsave"]
LOOK_WORDS = ["نگاه", "بررسی", "جستجو", "ببین", "بنگر", "تماشا", "دقت", "یافت", "پیدا"]
TORCH_WORDS = ["مشعل", "چراغ", "فانوس", "روشن", "افروز", "آتش"]
MOVE_WORDS = ["برو", "حرکت", "ادامه", "پیش", "جلو", "وارد", "خروج", "فرار"]
REST_WORDS = ["استراحت", "کمپ", "استراحت‌کن", "چادر", "بخواب", "نفس"]
SCENARIO_WORDS = ["سناریو", "ماجرا بساز", "شروع ماجرا"]
COMBAT_WORDS = ["نبرد", "جنگ", "شروع جنگ", "شروع نبرد", "حمله کن", "بجنگ", "درگیری"]
HELP_WORDS = ["راهنما", "کمک", "چی‌کار", "دستور"]
...
def parse_action(text: str, in_combat: bool = False, has_char: bool = True,
    ...
    # ۶) مشعل روشن کردن
    if _contains_any(t, TORCH_WORDS) and _contains_any(t, ["روشن", "افروز", "بزن", "آتش"]):
        return {"action": "torch"}
