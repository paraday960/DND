...
import android.app.*; import android.content.*; import android.os.*; import java.io.*; import org.json.JSONObject; import com.chaquo.python.Python; import com.chaquo.python.android.AndroidPlatform;
...
public class BotService extends Service {
    ...
    void run(){ try { writeConfig(); copyAsset(); if(!Python.isStarted()) Python.start(new AndroidPlatform(getApplicationContext())); Python.getInstance().getModule("android_bot").callAttr("main",getFilesDir().getAbsolutePath()); } catch(Throwable t){ log("CRASH: "+t); } }
