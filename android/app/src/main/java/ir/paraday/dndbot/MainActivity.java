...
public class MainActivity extends Activity {
    ...
    void build(){
        ...
        TextView title=new TextView(this); title.setText("🐉 D&D Server 2.10"); title.setTextSize(24); title.setTextColor(Color.rgb(245,210,110)); title.setGravity(Gravity.CENTER); root.addView(title);
